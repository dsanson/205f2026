---
title: "Russell's Three Puzzles"
date: 2026-09-02
center-title-slide: false
title-slide-attributes:
  data-background-image: media/Odilon_Redon_Chariot_of_Apollo.jpg
...
## (1) The Author of *Waverley* {.smaller}
...
- (AW1~1~) There is one and only one author of *Waverley* and George IV wished to know whether: Scott is he.
- (AW1~2~) George IV wished to know whether: there is one and only one author of *Waverley* and Scott is he.

How does this solve the puzzle?

## (2) The Present King of France {.smaller}

> By the law of excluded middle, either "A is B" or "A is not B" must be true.
...
@rs. The round square does not exist.

-   What does Frege's theory say about (@rs)?
-   What can Russell say about (@rs), using his distinction between primary and secondary occurrences?

## Proper Names {.smaller}
...
## Logically Proper Names {.smaller}
